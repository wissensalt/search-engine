...
import stylesCss from 'themes/search-engine-ui/styles.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_search-engine-ui_componentCss']) {
    
    document['_vaadintheme_search-engine-ui_componentCss'] = true;
  }
